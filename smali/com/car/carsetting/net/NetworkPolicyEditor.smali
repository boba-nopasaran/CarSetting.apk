.class public Lcom/car/carsetting/net/NetworkPolicyEditor;
...
.method public constructor <init>(Landroid/net/NetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method private forceMobilePolicyCombined()Z
    ...
    iget-object v5, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v5}, Lcom/car/carsetting/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method private setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->isMobilePolicySplit(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-virtual {v0, v1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v2, v0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v3}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-virtual {p0, p1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-static {p1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->buildDefaultPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v1, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v4, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicyMaybeUnquoted(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    :cond_0
    invoke-static {p1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->buildUnquotedNetworkTemplate(Landroid/net/NetworkTemplate;)Landroid/net/NetworkTemplate;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public read()V
    ...
    iget-object v6, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    iget-object v6, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-direct {p0}, Lcom/car/carsetting/net/NetworkPolicyEditor;->forceMobilePolicyCombined()Z
    ...
    invoke-virtual {p0}, Lcom/car/carsetting/net/NetworkPolicyEditor;->writeAsync()V
...
.method public setMobilePolicySplit(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/car/carsetting/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method public setPolicyCycleDay(Landroid/net/NetworkTemplate;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public setPolicyMetered(Landroid/net/NetworkTemplate;Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/car/carsetting/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public write([Landroid/net/NetworkPolicy;)V
    ...
    iget-object v0, p0, Lcom/car/carsetting/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public writeAsync()V
    ...
    new-instance v1, Lcom/car/carsetting/net/NetworkPolicyEditor$1;

    invoke-direct {v1, p0, v0}, Lcom/car/carsetting/net/NetworkPolicyEditor$1;-><init>(Lcom/car/carsetting/net/NetworkPolicyEditor;[Landroid/net/NetworkPolicy;)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcom/car/carsetting/net/NetworkPolicyEditor$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
